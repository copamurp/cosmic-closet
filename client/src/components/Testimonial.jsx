    ...
    constructor(props) {
        ...
        this.state      = {
            ...
            avatar: <FontAwesomeIcon
                            ...
                            border
                            style={{
                                backgroundColor: 'rgba(53, 53, 74, 0.5)',
                                borderColor:     '#4f4ddf',
                                boxShadow:       '0 0 1px #FEFEFE',
                            }}
                    />,
        }
    }
                    ...
                    <div className={'testimonial'}>
                        <div className={'user'}>
                            ...
                            <div>
                                ...
                                <p
                                        className={'user-date'}>{new Date(this.state.date).getMonth() + 1}/{new Date(
                                        this.state.date).getDate()}/{new Date(
